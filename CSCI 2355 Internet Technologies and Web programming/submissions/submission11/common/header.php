  ...
  <nav id="navbar">
    ...
    <li class="nav-item" onmouseover="showSubMenu('sm5')"
      ...
      <ul class="sub-menu" id="sm5">
        <li class="nav-item sidebar-item">
          <a href="./pages/merch-store.php">Products Catalogue</a>
        </li>
      </ul>
    </li>
    ...
    <li class="nav-item" onmouseover="showSubMenu('sm2')"
      ...
      <ul class="sub-menu" id="sm2">
        <li class="nav-item sidebar-item">
          <a href="./pages/get-quote.php">Get a quote</a>
        </li>
      </ul>
    </li>
    ...
    <li class="nav-item" onmouseover="showSubMenu('sm4')"
      ...
      <ul class="sub-menu" id="sm4">
        ...
        <li class="nav-item sidebar-item"><a href="./pages/customer-care.php">
